import {
  ...
  injected,
  mock
} from "./chunk-A6WFFWP2.js";
import "./chunk-7MQHQGKA.js";
import {
  withRetry,
  withTimeout
} from "./chunk-7MISXU67.js";
import "./chunk-QVPKBGQS.js";
import "./chunk-QGRJZ6ET.js";
import "./chunk-LYMWR3AX.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-L7SF5VBT.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-PU5MP3QQ.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-WISZD5UM.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-UIFTWSUL.js");
        ...
        const { SafeAppProvider } = await import("./dist-QEQL42RZ.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-ZMWWIHS2.js");
