...
export function Account() {
  ...
  const { data: ensName } = useEnsName({ address }); // Get the ENS name associated with the address
  const { data: ensAvatar } = useEnsAvatar({ name: ensName || undefined }); // Get the ENS avatar
